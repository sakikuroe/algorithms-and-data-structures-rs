...
impl<T> Graph<T> {
    ...
    ///
    /// # Args
    /// - `u`: 頂点番号。`0..vertex_count()` の範囲でなければならない。
    ///
    /// # Returns
    /// `usize`: `u` から出る辺の本数。
    ///
    ...
    ///
    /// # Args
    /// - `src`: 辺の始点。`0..vertex_count()` の範囲でなければならない。
    /// - `dst`: 辺の終点。`0..vertex_count()` の範囲でなければならない。
...
impl<T: Clone> Graph<T> {
    ...
    ///
    /// # Args
    /// - `u`: 辺の一方の端点。`0..vertex_count()` の範囲でなければならない。
    /// - `v`: 辺のもう一方の端点。`0..vertex_count()` の範囲でなければならない。
